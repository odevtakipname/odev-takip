    ...
    var DayTableMixin = FC.DayTableMixin = {
        ...
        renderHeadDateCellHtml: function(date, colspan, otherAttrs) {
            ...
            return '' +
                ...
                view.buildGotoAnchorHtml({ date: date, forceOff: this.rowCnt > 1 || this.colCnt === 1 },
    ...
    var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
        ...
        renderNumberCellHtml: function(date) {
            ...
            if (this.view.cellWeekNumbersVisible && (date.day() == weekCalcFirstDoW)) {
                html += this.view.buildGotoAnchorHtml({ date: date, type: 'week' }, { 'class': 'fc-week-number' },
            ...
            return '<tr class="fc-list-heading" data-date="' + dayDate.format('YYYY-MM-DD') + '">' +
                ...
                (mainFormat ?
                    view.buildGotoAnchorHtml(
                        dayDate, { 'class': 'fc-list-heading-main' },
                        htmlEscape(dayDate.format(mainFormat)) // inner HTML
                    ) :
                    '') +
                (altFormat ?
                    view.buildGotoAnchorHtml(
                        dayDate, { 'class': 'fc-list-heading-alt' },
