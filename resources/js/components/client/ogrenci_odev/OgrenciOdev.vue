                                ...
                                <tbody>
                                    ...
                                    >
                                        <td style="width: 80px !important">
                                            ...
                                            >
                                                <i
                                                    ...
                                                    @click="edit(index)"
                                                    title="Detayları Görmek için tıklayınız"
                                                ></i
                                            ></a>
                                        </td>
                                        <td style="width: 80px !important">
                                        ...
                                        <td class="d-flex flex-wrap">
                                            <span
                                                class="badge badge-m light badge-primary"
                                                v-for="(
                                                    keyyy, index
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="unvan"
                                        class="form-control"
                                        v-model="form.anahtar_kelime"
                                        placeholder="anahtar_kelime1 anahtar_kelime2 "
                                    />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        v-model="form.amac"
                                        rows="7"
                                        placeholder="Proejnin amacaını en az 200 kelime ile anlatınız"
                                    ></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea
                                        class="form-control"
                                        v-model="form.metaryel"
                                        rows="7"
                                        placeholder="en az 300 kelime ile anlatınız"
                                    ></textarea>
                                </div>
                            </div>
                            <div
                                class="col-md-12"
                                v-if="form.durum == 'Red Edildi'"
                            >
                                <div class="form-group">
                                    <label for="">Red Nedeni </label>
                                    <textarea
                                        class="form-control"
                                        v-model="form.red_nedeni"
                                        rows="3"
                                        disabled
                                    ></textarea>
                                </div>
                    ...
                    >
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for=""
                                        >Proje Raporu *(doc/docx)</label
                                    >
                                    <input
                                        type="file"
                                        class="form-control"
                                        @change="
                                            fileUpload($event, 'projeDocs')
                                        "
                                        required
                                    />
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        type="file"
                                        class="form-control"
                                        @change="fileUpload($event, 'projePdf')"
                                        required
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 pt-5 pb-5" v-if="form.rapor_pdf">
                            <div class="col-md-12">
                                <a
                                    :href="'/public/files/' + form.rapor_word"
                            ...
                            <div class="col-md-12 pt-5">
                                <a
                                    :href="'/public/files/' + form.rapor_word2"
                                    class="alert alert-success alert-dismissible"
                                    role="alert"
                                    download=""
                                >
                            ...
                            <div class="col-md-12 pt-5">
                                <a
                                    :href="'/public/files/' + form.rapor_pdf"
                                    class="alert alert-success alert-dismissible"
                                    role="alert"
                                    download=""
                                >
                        ...
                        <div
                            class="col-md-12"
                            v-if="form.durum == 'Rapor Red Edildi'"
                        >
                            <div class="form-group">
                                <label for="">Red Nedeni </label>
                                <textarea
                ...
                <div class="card-body">
                    <form method="POST" @submit.prevent="onSubmit()">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input
                                        type="file"
                                        class="form-control"
                                        @change="fileUpload($event, 'tezDocs')"
                                    />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input
                                        type="file"
                                        class="form-control"
                                        @change="fileUpload($event, 'tezPdf')"
                                    />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input
                                        type="file"
                                        class="form-control"
                                        @change="fileUpload($event, 'tezDocs2')"
                                    />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 pt-5 pb-5" v-if="form.tez_pdf">
                            <div class="col-md-4">
                                <a
                                    :href="'/public/files/' + form.tez_word"
                                    class="alert alert-success alert-dismissible"
                                    role="alert"
                                    download=""
                                >
                            ...
                            <div class="col-md-4">
                                <a
                                    :href="'/public/files/' + form.tez_word2"
                                    class="alert alert-success alert-dismissible"
                                    role="alert"
                                    download=""
                                >
                            ...
                            <div class="col-md-4">
                                <a
                                    :href="'/public/files/' + form.tez_pdf"
                                    class="alert alert-success alert-dismissible"
                                    role="alert"
                                    download=""
                                >
                        ...
                        <div
                            class="col-md-12"
                            v-if="form.durum == 'Tez Red Edildi'"
                        >
                            <div class="form-group">
                                <label for="">Red Nedeni </label>
                                <textarea
