...
<div class="content-body">
    <!-- row -->
    <div class="container-fluid" v-if="user.unvan == 'sistem-yoneticisi'">
        <div class="row">
    ...
    <div class="container-fluid" v-if="user.unvan == 'proje-yurutucusu'">
      
    </div>
    <div class="container-fluid" v-if="user.unvan == 'proje-ogrencisi'">
        <div class="row">
            <div class="col-xl-12 col-xxl-12">
                <div class="row">
                    <div class="col-sm-4">
                ...
                <div class="col-md-6 pt-5 pb-5" v-if="danisman_seen">
                                <h3 class="pb-5">Danışman Bilgileri</h3>

                    <div class="col-md-6 ">
                        <a class="alert alert-success alert-dismissible" role="alert">
                            {{danisman.ad }}
                        </a>
                    </div>
    ...
    methods: {
        messageAlert(title, message, type) {
            const setting = {
                ...
                type: type,
                mode: "prompt",
                answers: { Eminim: true, İptal: false },
            };
            return this.$vToastify.success(setting);
        },
        messageAlert2(title, message, type) {
            const setting = {
                title: title,
                body: message,
                type: type,
        ...
        takipstart() {
            const control = confirm(
                "İşlem Gerçekleşmek Üzere Dönemi başlatmak istediğinize emin misiniz? Burda Öğretmen ve Öğrenciler eşleştirirlir !!!"
            );
            ...
            axios
                ...
                .catch((err) => {
                    this.messageAlert2("Başarısız", "İşlem Başarısız", "error");
                    console.log(err);
                });
        },
    },
